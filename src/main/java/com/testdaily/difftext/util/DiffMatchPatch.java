package com.testdaily.difftext.util;
...
public class DiffMatchPatch {
    ...
    public static Map<Integer,SpaceIndex> spaceMap=new HashMap<>();
    ...
    public String diff_prettyHtml(LinkedList<Diff> diffs) {
        ...
        for (Diff aDiff : diffs) {
            ...
            switch (aDiff.operation) {
                case INSERT:
                    html.append("<INS STYLE=\"background:#fd6c6c;padding:0 4px;color:#fff;\" TITLE=\"i=").append(i)
                            .append("\">").append(text).append("</INS>");
                    break;
                case DELETE:
                    html.append("<DEL STYLE=\"background:#678be0;padding:0 4px;color:#fff;\" TITLE=\"i=").append(i)
...
class SpaceIndex{
    ...
    private Integer errorLength;//错误长度

    private Integer goodLength;//原本长度
